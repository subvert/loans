...
/**
 * Performance test for the Loan entity.
 */
class LoanGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Loan entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created loan")
                .get("${new_loan_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created loan")
            .delete("${new_loan_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
